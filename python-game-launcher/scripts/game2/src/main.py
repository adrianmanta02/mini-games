...
ghostweavers = Message(WIDTH//2 + 50, HEIGHT//2 - 90, 90, "GhostWeaver", title_font, (255, 255, 255), win)
...
p_image = pygame.transform.scale(pygame.image.load('Assets/Player/PlayerIdle1.png'), (64,64))
p_rect = p_image.get_rect(center=(700, 200))
p_dy = 1
p_ctr = 1

# Ghost for main menu
ghost_image = pygame.transform.scale(pygame.image.load('Assets/Ghost/Enemywalk1.png'), (64, 64))
ghost_rect = ghost_image.get_rect(center=(130, 200))
ghost_dy = 1
ghost_ctr = 1
...
while running:
	...
	if main_menu:
		...
		# Draw ghost on the left
		win.blit(ghost_image, ghost_rect)
		ghost_rect.y += ghost_dy
		ghost_ctr += ghost_dy
		if ghost_ctr > 15 or ghost_ctr < -15:
			ghost_dy *= -1
		...
		MessageBox(win, about_font, 'GhostWeaver', info)
