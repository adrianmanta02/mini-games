...
from obstacle import Platform, ShadowZone, Hazard, FormBarrier
...
class LevelManager:
    ...
    def create_level_1(self):
        """Level 1 - Tutorial: invata mecanica Shadow Switch"""
        ...
        # shadow zones - forteaza shadow form
        level.shadow_zones = [
            ShadowZone(1150, 200, 200, 450),
            ShadowZone(2050, 150, 250, 500),
        ]

        # form barriers - trebuie sa fii in forma corecta!
        level.form_barriers = [
            FormBarrier(750, 350, 30, 250, "light"),  # bariera galben - doar light form
            FormBarrier(1050, 250, 30, 400, "shadow"),  # bariera violet - doar shadow form
    ...
    def create_level_2(self):
        ...
        # shadow zones - REDESIGN sa nu se suprapuna cu barriers
        level.shadow_zones = [
            ShadowZone(500, 350, 200, 300),  # mai mica, nu atinge bariera
            ShadowZone(1250, 200, 300, 450),
            ShadowZone(2000, 150, 300, 500),  # mutat putin
            ShadowZone(2850, 250, 350, 400),
        ]

        # form barriers - plasate STRATEGIC
        level.form_barriers = [
            FormBarrier(380, 480, 30, 170, "light"),  # inainte de shadow zone
            FormBarrier(800, 320, 30, 330, "shadow"),  # intre platforme
    ...
    def create_level_3(self):
        """Level 3 - BOSS LEVEL: Forward perspective cu final epic"""
        level = Level(3, "forward")
        level.width = 2800
        level.finish_x = level.width - 200
        level.portal = Portal(level.finish_x)

        # platforme pentru perspective
        level.platforms = [
    ...
    def create_level_4(self):
        """Level 4 - FORWARD PERSPECTIVE: merge in fata, platforme care se micsoreaza"""
        level = Level(4, "forward")
        level.width = 4000  # foarte lung pentru depth
        level.finish_x = level.width - 150
        level.portal = Portal(level.finish_x)

        # platforme normale (mai putine, sunt "adanci")
        level.platforms = [
        ...
        # shadow zones - "tuneluri" de umbra
        level.shadow_zones = [
        ...
        # form barriers - mai multe, mai strategic
        level.form_barriers = [
        ...
        # light orbs - mai multe, essential pentru supravietuire
        level.light_orbs = [
            LightOrb(500, 530),
            LightOrb(800, 400),
            LightOrb(1000, 470),
